...
pretest_X, pretest_y = make_classification(n_samples=102, n_features=200, random_state=42)
pretest_X_reg, pretest_y_reg = make_regression(n_samples=102, n_features=10, random_state=42)
